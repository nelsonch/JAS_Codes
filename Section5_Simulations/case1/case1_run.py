...
####### Fit HMC 
fit = MarketMixModel(m = m, n = nn, l = 5, year = int(w/52), mcmc = 30000, path_len = 0.003, step_size = 0.001)
fit3 = fit.HMC(init, Y)
tra = fit3['tra']
...
#############
true = np.array([0.5, 0.5, 0.2, 0.2, 0.3, 0.3, 1, 1, 1, 1, 0.25])
...
case1_results = pd.DataFrame(rr, columns=['true', 'HMC', 'BFGS', 'SQP']) 

################
case1_results_pd = pd.DataFrame(case1_results)
case1_results_pd.to_csv('case1_results.csv')
