...
####### Fit HMC 
fit = MarketMixModel(m = m, n = nn, l = 5, year = int(w/52), mcmc = 30000, path_len = 0.002, step_size = 0.001)
fit3 = fit.HMC(init, Y)
tra = fit3['tra']
...
case5_results = pd.DataFrame(rr, columns=['true', 'HMC', 'BFGS', 'SQP']) 

################
case5_results_pd = pd.DataFrame(case5_results)
case5_results_pd.to_csv('case5_results.csv')
