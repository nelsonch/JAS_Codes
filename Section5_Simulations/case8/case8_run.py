...
case8_results = pd.DataFrame(rr, columns=['true', 'HMC', 'BFGS', 'SQP']) 

################
case8_results_pd = pd.DataFrame(case8_results)
case8_results_pd.to_csv('case8_results.csv')
