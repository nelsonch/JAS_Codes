...
class MarketMixModel():
    ...
    def __init__(self, m = 7, n = 3, l = 5, year = 1, mcmc = 8000, path_len = 0.05, step_size = 0.01):
        #######
    ...
    def HMC(self, phi, Y):
        ...
        ############## computer R^2
        #res1 = res.copy()
        #res1[0:self.m] = np.log(res[0:self.m]/(1 - res[0:self.m]))
        #R_squared = self._compute_R_squared(res1, self.Y)
    ...
    def _compute_prior(self):
        ...
        #print(self.beta_s_random)
        log_beta_s_random = self._log_truncate_norm_pdf_nelson(self.beta_s_random, a = 0.5, b = 1.5, loc = 1, scale = 0.02).sum()
