...
Y.to_csv('case3_data.csv')
#Y = pd.read_csv('case3_data.csv').iloc[:, 1:]
############ Fit MLE
############## Fit MLE 
######### get the bounds
...
case3_results = pd.DataFrame(rr, columns=['true', 'HMC', 'BFGS', 'SQP']) 

################
case3_results_pd = pd.DataFrame(case3_results)
case3_results_pd.to_csv('case3_results.csv')
