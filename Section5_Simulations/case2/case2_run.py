...
case2_results = pd.DataFrame(rr, columns=['true', 'HMC', 'BFGS', 'SQP']) 

################
case2_results_pd = pd.DataFrame(case2_results)
case2_results_pd.to_csv('case2_results.csv')
